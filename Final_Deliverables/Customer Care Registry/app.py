...
connectionstring = "DATABASE=;HOSTNAME=;PORT=;PROTOCOL=TCPIP;UID=;PWD=;SECURITY=SSL;"
...
@app.route('/')
def home():
    message = "TEAM ID : PNT2022TMID00466" +" "+ "BATCH ID : B4-4M6E "
...
def remove():
    ...
    if otp == 'C':
        try:
            ...
            return redirect(url_for('signuppage.html'))
    if otp == 'A':
        try:
